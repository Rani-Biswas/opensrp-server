CREATE TABLE report.country_tb (
    id SERIAL,
...
CREATE TABLE report.district_new (
    id SERIAL,
    country_name integer NOT NULL,
...
CREATE TABLE report.subdistrict_new (
    id SERIAL,
...
CREATE TABLE report.location_new (
    id SERIAL,
...
CREATE TABLE report.health_centers_new (
    ...
    hospital_address character varying(200) NOT NULL,
    parent_hospital character varying(200) DEFAULT ' '::character varying,
...
CREATE TABLE report.user_masters_new (
    id SERIAL,
...
CREATE TABLE report.app_configuration (
    id SERIAL,
    country_name integer NOT NULL,
...
CREATE TABLE report.directions (
    id SERIAL,
...
CREATE TABLE report.form_fields (
    id SERIAL,
...
CREATE TABLE report.investigation (
    id SERIAL,
...
CREATE TABLE report.poc_backup (
    id SERIAL,
...
CREATE TABLE report.poc_table (
    ...
    wifename character varying(200),
    CONSTRAINT poc_table_pkey PRIMARY KEY (id)
);

CREATE TABLE report.visit_configuration (
    id SERIAL,
